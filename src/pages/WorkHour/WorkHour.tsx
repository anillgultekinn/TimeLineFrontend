...
export default function WorkHour() {
    ...
    const handleDeleteWorkHour = async () => {
        try {
            await workHourService.delete(selectedDeleteId);
            toast.success("Çalışma Saati Silindi.");
            getWorkHourByAccountId();
                        ...
                        <tbody>
                            {workHours?.items.map(workHour => (
                                <tr >
                                    ...
                                    <td onClick={() => handleOpenDeleteModal(String(workHour.id))}>
                                        <svg className='process-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                            ...
                            <DeleteCard
                                ...
                                handleDelete={handleDeleteWorkHour}
                                title="Silme Onayı"
                                body="Bu çalışma saatini silmek istediğinize emin misiniz?"
                            />
                        </tbody>
                        <tbody>
                            <tr>
